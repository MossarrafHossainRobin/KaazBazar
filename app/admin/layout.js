...
const menuItems = [
  ...
  { id: "providers", name: "Service Providers", icon: Shield, href: "/admin/providers" },
  { id: "orders", name: "Orders", icon: DollarSign, href: "/admin/orders" },
  { id: "reviews", name: "Reviews", icon: Star, href: "/admin/reviews" },
  { id: "reports", name: "Reports", icon: Activity, href: "/admin/reports" },
...
export default function AdminLayout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Sidebar */}
      <aside 
        className={`fixed lg:sticky top-0 left-0 z-40 h-screen bg-gray-900 shadow-xl transition-all duration-300 ${
          isSidebarOpen ? 'w-72' : 'w-20'
        } ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`}
      >
        <div className="flex flex-col h-full">
          {/* Logo */}
          <div className={`p-6 border-b border-gray-800 ${!isSidebarOpen && 'lg:px-2'}`}>
